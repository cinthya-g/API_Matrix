...
/**
 * Clase que almacena el prototipo de método para utilizar en operaciones unarias.
...
public abstract class UnaryOperator extends Matrix {
	...
	/**
	 * Método heredado por sus subclases para crear un objeto cuando se desea 
	 * ejecutar un cálculo a una matriz (transoformaciones lineales: MatrixAdjoint, MatrixInverse, MatrixTranspose)
	 * @param m (Matrix)
